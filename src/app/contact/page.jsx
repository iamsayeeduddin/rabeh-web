  ...
  return (
    <div>
      ...
      <section className="flex flex-col items-center gap-4">
        <p className="text-md text-primary">About us</p>
        <h1 className="text-4xl">We’re a distributed team</h1>
      ...
      <section className="flex flex-col items-center gap-4 my-24">
        <p className="text-md text-primary font-bold">Contact us</p>
