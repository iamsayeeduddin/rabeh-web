      ...
      <div className="w-full flex flex-col p-[72px] mt-10 ">
        ...
        >
          ...
          <div className="text-regular items-center justify-center">
            ...
            used by all the <br /> companies you know and love? Join the team —
            we’re hiring!
          </div>
        </div>
        <div className="py-2 w-full flex mt-10 justify-center gap-10 mb-5">
          ...
          >
            <span className={`px-3 py-2 rounded-md ${true ? "bg-white text-[#344054]" : "text-[#667085]"}`}>
              View all
            </span>
            <span className={`px-3 py-2 rounded-md ${false ? "bg-white text-[#344054]" : "text-[#667085]"}`}>
              Design
            </span>
            <span className={`px-3 py-2 rounded-md ${false ? "bg-white text-[#344054]" : "text-[#667085]"}`}>
            ...
            >
              ...
              <div className="mt-2">
                <h3 className="text-2xl font-semibold flex items-center">
                  {job.title}
                  <span className="px-2 py-1 rounded-full text-sm border-2 ml-2 flex items-center" style={{
