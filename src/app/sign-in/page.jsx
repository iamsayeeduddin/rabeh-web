      ...
      <div className="flex flex-col gap-5 bg-[#FFFFFF] px-[112px] py-[32px] rounded-b-[12px] " style={{ boxShadow: '0px 1px 2px 0px #1018280F, 0px 1px 3px 0px #1018281A' }}>
        ...
        <div className="flex flex-row gap-3 mt-12">
          ...
          >
            ...
            <div
              className={`font-bold mb-4 text-[18px] ${fonts.inter.className}`}
            >
              Entrepreneur
            </div>
          </div>
          <div
            className={`flex flex-col items-center justify-center gap-8 px-8 py-3 w-[183.33px] bg-white rounded-[20px] shadow-[0px_8.15px_6.52px_0px_rgba(0,0,0,0.0079),0px_50px_100px_0px_rgba(0,0,0,0.04)] ${fonts.spaceG.className}`}
          >
