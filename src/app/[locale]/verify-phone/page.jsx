...
function Page({ isReset, userType }) {
  let phoneNumber = JSON.parse(localStorage.getItem("user"))?.phoneNumber;
  ...
  const setUpRecaptcha = () => {
    if (typeof window !== "undefined" && auth) {
      // This ensures the code runs only in the browser environment
      ...
      console.log("Window or Firebase auth is undefined.");
    }
  };
