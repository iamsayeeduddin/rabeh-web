  ...
  return (
    <div>
      ...
      <div className="flex w-full md:p-[72px]">
        <div className={classNames("grid md:grid-cols-3 gap-10 py-[96px] px-5", locale === "en" ? fonts.urbanist.className : "")}>
          <FAQItem
            ...
            answer={t("pricingScalesWithCompany")}
          />
          <FAQItem
            ...
            question={t("canIChangePlanLater")}
            answer={t("pricingScalesWithCompany")}
          />
          <FAQItem
            ...
            question={t("cancellationPolicy")}
            answer={t("refundPolicy")}
          />
          <FAQItem
            ...
            question={t("canAddInfoToInvoice")}
            answer={t("addInfoToInvoiceExplanation")}
          />
          <FAQItem
            ...
            question={t("billingExplanation")}
            answer={t("billingDetails")}
          />
          <FAQItem
            iconPath="M20 17H4M4 17L8 13M4 17L8 21M4 7H20M20 7L16 3M20 7L16 11"
            question={t("changeEmail")}
            answer={t("changeEmailInstructions")}
          />
        </div>
      </div>
      <div className="md:p-[96px] w-full p-5 flex flex-col items-center">
        <div
