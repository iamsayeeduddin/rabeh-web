  ...
  return (
    <div>
      ...
      <section className="flex flex-col items-center gap-4 p-5 md:p-0 ">
        ...
        <h1 className={"text-4xl font-bold text-center " + (locale === "en" ? fonts.urbanist.className : "")}>{t("distributedTeam")}</h1>
        <h3 className={"text-xl text-[#475467] text-center  " + (locale === "en" ? fonts.urbanist.className : "")}>{t("globalOffices")}</h3>
        <img src="/assets/map.png" alt="" className="w-full my-24 " />
      </section>
      <section className={"grid md:grid-cols-12  my-4 " + (locale === "en" ? fonts.inter.className : "")}>
