      ...
      >
        ...
        <div className="flex md:flex-row flex-col gap-3 mt-12 items-center ">
          <div
            ...
            className={`flex flex-col cursor-pointer items-center justify-center gap-8 px-8 py-3 ${
          ...
          <div
            ...
            } flex-col items-center cursor-pointer justify-center gap-8 px-8 py-3 w-[183.33px] bg-white rounded-[20px] shadow-[0px_8.15px_6.52px_0px_rgba(0,0,0,0.0079),0px_50px_100px_0px_rgba(0,0,0,0.04)] hover:bg-[#00B8D9] hover:text-white ${
              locale === "en" ? fonts.spaceG.className : ""
            }`}
          >
          ...
          <div
            ...
            } flex-col items-center cursor-pointer justify-center gap-8 px-8 py-3 w-[183.33px] bg-white rounded-[20px] shadow-[0px_8.15px_6.52px_0px_rgba(0,0,0,0.0079),0px_50px_100px_0px_rgba(0,0,0,0.04)] hover:bg-[#004677] hover:text-white ${
              locale === "en" ? fonts.spaceG.className : ""
            }`}
          >
