      ...
      <div className="flex w-full md:p-[72px]">
        <div className={"grid  md:grid-cols-3 gap-10 py-[96px] px-5 " + fonts.urbanist.className}>
          <div className="flex flex-col gap-8 ">
            ...
            <div className={"text-[20px] font-bold"}>Is there a free trial available?</div>
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className={"text-[20px] font-bold"}>Can I change my plan later?</div>
            <div className="text-[16px]">
              Of course. Our pricing scales with your company. Chat to our friendly team to find a solution that works for you.
            </div>
          </div>
          <div className="flex flex-col gap-6 ">
            ...
            <div className={"text-[20px] font-bold"}>What is your cancellation policy?</div>
            <div className="text-[16px]">
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className={"text-[20px] font-bold"}>Can other info be added to an invoice?</div>
            <div className="text-[16px]">
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className={"text-[20px] font-bold"}>How does billing work?</div>
            <div className="text-[16px]">
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className={"text-[20px] font-bold"}>How do I change my account email?</div>
            <div className="text-[16px]">
