  ...
  const cardData = [
    {
      ...
      content: [
        ...
        "Luctus cum purus bibendum risus nibh cursus integer.",
      ],
    },
    {
      ...
      <div className="grid md:grid-cols-3 gap-7 md:p-28 p-5">
        {cardData.map((card, index) => (
          <div
            key={index}
            className={
              "p-10 rounded-[20px] bg-white w-max-[385px] h-auto shadow-[0px_8.15px_6.52px_0px_rgba(0,0,0,0.0079),0px_50px_100px_0px_rgba(0,0,0,0.04)] m-2 " +
