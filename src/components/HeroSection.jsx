...
const Hero = ({
  ...
  return (
    <div className={" flex flex-col gap-[80px] " + fonts.inter.className}>
      <div className="container mx-auto flex flex-col lg:flex-row items-center w-max-[1440px] h-max-[713px] p-[72px]">
        <div className="lg:w-1/2 px-4">
          <div className=" bg-[#F9F8FD] inline-block text-black px-4 py-4  mb-4  rounded-full   ">
          ...
          <p className="text-lg mb-8 text-[#737373]">{description}</p>
          <div className={"flex space-x-4 " + fonts.spaceG.className}>
            ...
            <Link href={button2Link} className="  text-black px-6 py-3 border border-gray-700 rounded-lg hover:bg-gray-200 ">
              {button2Text}
            </Link>
          </div>
        </div>
