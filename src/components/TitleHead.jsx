...
function TitleHead({ title, desc }) {
  ...
  return (
    <div className="py-12 px-6 sm:py-16 sm:px-10 md:py-24 md:px-20 bg-[url('/assets/title-bg.png')] bg-[length:300px_100px] rtl:bg-none md:bg-auto ltr:bg-right-top rtl:bg-left-top rtl:bg-no-repeat">
