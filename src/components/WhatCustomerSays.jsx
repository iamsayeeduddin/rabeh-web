...
const WhatCustomerSays = () => {
  ...
  const testimonials = [
    {
      title: "Customer 1",
      description: "Investing through RABEH has been a seamless experience. The platform's transparency and advanced tools gave me the confidence to make informed decisions.",
      name: "John Doe",
      position: "Investor",
      imageUrl: "/user1.png", 
    },
  ...
  return (
    <div className="flex flex-col p-[72px] bg-white">
      <div className="justify-start text-sm">Testimonial</div>
